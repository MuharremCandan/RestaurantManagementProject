...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured whle lsting invoice items"})
			return
		}
...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured ehile listing invoice item"})
			return
		}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		validatonErr := validate.Struct(invoice)
